...
class RolePermissionsController extends Controller
{
    ...
    public function findById(Request $request, $id) {
        AuthProvider::has($request, 'role-permissions-read');
        try {
    ...
    public function store(Request $request, $id = null) {
        if ($id) AuthProvider::has($request, 'role-permissions-update');
        else AuthProvider::has($request, 'role-permissions-create');
        try {
    ...
    public function restore(Request $request, $id = null) {
        AuthProvider::has($request, 'role-permissions-restore');
        try {
    ...
    public function remove(Request $request, $id) {
        AuthProvider::has($request, 'role-permissions-delete');
        try {
            $payload = $request->all();
    ...
    public function exportCSV($data) {
        ...
        $fileName = 'RolePermissions-'.H_getCurrentDate();
